...
(
    ...
    `ProfileEvent_ReplicaYieldLeadership` UInt64, 
    ...
    `ProfileEvent_LeaderElectionAcquiredLeadership` UInt64, 
    ...
    `ProfileEvent_NetworkErrors` UInt64, 
    ...
    `CurrentMetric_LeaderReplica` Int64, 
    `CurrentMetric_MemoryTracking` Int64, 
    `CurrentMetric_MemoryTrackingInBackgroundProcessingPool` Int64, 
    `CurrentMetric_MemoryTrackingInBackgroundMoveProcessingPool` Int64, 
    `CurrentMetric_MemoryTrackingInBackgroundSchedulePool` Int64, 
    `CurrentMetric_MemoryTrackingForMerges` Int64, 
    `CurrentMetric_LeaderElection` Int64, 
